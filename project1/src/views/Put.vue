    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    id: [
                        {required: false, message: '请输入id', trigger: 'change'}
                    ],
                    flowerName: [
                    ...
                    grade: [
                        {required: false, message: '请输入级别', trigger: 'blur'}
                    ],
                }
            };
        },
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        // alert('submit!');
                        const _this = this
                        this.$axios.put('/user/updata',this.ruleForm).then(res => {
